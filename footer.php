<?php if (!defined('__TYPECHO_ROOT_DIR__')) exit; ?>
	...
	<script src="<?php $this->options->themeUrl('js/addline.js'); ?>" ></script>
...
<script src="<?php $this->options->themeUrl('js/prism-toolbar.js'); ?>" data-no-instant></script>    
    <script src="<?php $this->options->themeUrl('js/prism-copy-to-clipboard.js'); ?>" data-no-instant></script>
    <script src="<?php $this->options->themeUrl('js/clipboard.min.js'); ?>" data-no-instant></script>
<script src="<?php $this->options->themeUrl('js/addline.js'); ?>" data-no-instant></script>
	<script src="<?php $this->options->themeUrl('js/prism-line-numbers.js'); ?>" data-no-instant></script>
<script src="http://apps.bdimg.com/libs/jquery/2.1.4/jquery.min.js" data-no-instant></script>
<script src="<?php $this->options->themeUrl('js/addimg.js'); ?>" data-no-instant></script>
<script src="<?php $this->options->themeUrl('js/photoswipe.js'); ?>" data-no-instant></script>
<script src="<?php $this->options->themeUrl('js/photoswipe-ui-default.js'); ?>" data-no-instant></script>
